...
type AuthRepositoryInterface interface {
	...
	// ========================================
	PrivateCreateUser(ctx context.Context, user *entity.User) (*entity.User, error)
	PrivateGetUsers(ctx context.Context, params params.QueryParams) (*entity.PaginatedUserWithProfileEntity, error)
	...
	PrivateDeleteUser(ctx context.Context, id uuid.UUID) error
	// ========================================
	// Role Management Operations
	// ========================================
	PrivateCreateRole(ctx context.Context, role *entity.Role) (*entity.Role, error)
	...
	GetRoleByNameOrSlug(ctx context.Context, name, slug string) (*entity.Role, error)
	...
	GetUserIDsByPermissionAndDepartment(ctx context.Context, permission string, departmentID uuid.UUID) ([]uuid.UUID, error)
	...
	GetUserIDsByRoleID(ctx context.Context, roleID uuid.UUID) ([]uuid.UUID, error)
